...
public sealed record CommandInfo(string Name, string? DisplayName = null, IEnumerable<string>? RequiredParameters = null, IEnumerable<string>? OptionalParameters = null) : IOrganizable
{
    ...
    /// </summary>
    public IEnumerable<string> RequiredParameters { get; } = RequiredParameters ?? new List<string>();

    /// <summary>
    /// Optional parameters for the command
    /// </summary>
    public IEnumerable<string> OptionalParameters { get; } = OptionalParameters ?? new List<string>();
