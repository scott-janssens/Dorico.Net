...
/// <summary>
/// Once a connection to the web socket is established, it is required to send a Connect message in order to allow
/// communication with Dorico. If Dorico or the user blocks the connection attempt then the web socket will be dropped.
/// </summary>
...
/// communication with Dorico. If Dorico or the user blocks the connection attempt then the web socket will be dropped.
/// </summary>
/// <param name="ClientName">The name to present to the user when asking whether communication should be
/// allowed.</param>
...
/// <param name="HandshakeVersion">The version of the handshaking protocol the client wants to use</param>
public record ConnectWithSessionRequest(string ClientName, string SessionToken, string HandshakeVersion = "1.0")
    : DoricoRequestBase<Response>
{
    /// <inheritdoc/>
    public override string Message =>
